...
class AppColors {
  ...
  static const primaryLight = Color(0xFFFF9BBC);
  static const greyPrimary = Color(0xff9E9E9E);
  static const greyLight = Color(0xffCECECE);
  static const greyExtraLight = Color(0xFFE0E0E0);
  static const greyMedium = Color(0xFFC7C7C7);
  ...
  static const lightTextDisabled = Color(0xFF999999);
  static const textDisabledLighter = Color(0xffB2B2B2);
  static const greenText = Color(0xFF31B042);
