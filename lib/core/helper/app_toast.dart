...
class AppToast {
  ...
  static void _show(
    ...
    toastification.show(
      ...
      title: Text(
        title ?? _defaultTitle(context, type),
      ...
      borderSide: BorderSide(
        color: _typeColor(context, type).withValues(alpha: 0.2),
        width: 1.5,
      ),
      boxShadow: [
        BoxShadow(
  ...
  static Color _typeColor(BuildContext context, ToastificationType type) {
  ...
  static String _defaultTitle(BuildContext context, ToastificationType type) {
    switch (type) {
      case ToastificationType.success:
  ...
  static IconData _defaultIcon(ToastificationType type) {
    switch (type) {
      case ToastificationType.success:
