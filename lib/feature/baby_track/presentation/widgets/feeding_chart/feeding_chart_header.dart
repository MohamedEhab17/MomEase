...
/// Header row containing the chart title, date-range subtitle, and the
/// weekly/monthly toggle tabs.
class FeedingChartHeader extends StatelessWidget {
  const FeedingChartHeader({
    super.key,
  ...
  /// Pre-formatted date range string (e.g. "1 Jan – 7 Jan").
