...
class CryingConfidenceBadge extends StatelessWidget {
  const CryingConfidenceBadge({super.key, required this.confidence});
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          6.horizontalSpace,
          Text(
            context.trContext(TK.babyCryConfidence, namedArgs: {'pct': pct}),
            style: TextStyle(
              fontSize: 13.sp,
